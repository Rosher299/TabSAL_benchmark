...
from .tabula_utils import _array_to_dataframe, _get_column_distribution, _convert_tokens_to_text, \
...
class Tabula:
    ...
    def __init__(self, llm: str, experiment_dir: str = "trainer_tabula", epochs: int = 100,
        ...
        self.llm = llm
        self.tokenizer = AutoTokenizer.from_pretrained(self.llm, device_map="auto")
        self.tokenizer.pad_token = self.tokenizer.eos_token
        self.config = AutoConfig.from_pretrained(self.llm, device_map="auto")
